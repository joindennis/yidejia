 ...
 * 功能: 皮肤分析器模型类
 */
class module_en_orderConfirmation {

    private $db; //数据库对象
    private $cache; //缓存对象
    private $key_prefix = "EN_OAT_ORDER_CONFIRMATION_"; //缓存key前缀
    private $table_name = 'oat_order_confirmation'; //表名称
     ...
     *
     * @param int $id orderConfirmation id
     * @return null
     */
