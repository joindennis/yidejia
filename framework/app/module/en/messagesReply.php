 ...
 * 功能: 皮肤分析器模型类
 */
class module_en_messagesReply {

    private $db; //数据库对象
    private $cache; //缓存对象
    private $key_prefix = "EN_OAT_USER_MESSAGES_REPLY_"; //缓存key前缀
    private $table_name = 'oat_user_messages_reply'; //表名称
