 ...
 * 栏目：国际站API
 */
class api_en_wishList {

    private $model;

    public function __construct() {
        $this->model = new module_en_wishList();
    }
    ...
    /**
     * api： en.wishlist.clearCacheById
     * function：clear cache data by id
     * call：CT_Api::post();
     * param：$id: wishlist id  (must be assigned)
     */
