...
/**
 * 模块：en.orderConfirmation
 * 功能: 国际站皮肤分析器管理
 * 栏目：国际站API
 */
class api_en_orderConfirmation {

    private $model;

    public function __construct() {
        $this->model = new module_en_orderConfirmation();
    }

    /**
     * api： en.orderConfirmation.get
     * 功能：根据皮肤分析ID获取皮肤分析信息
     * 调用：CT_Api::get();
     * 参数：$id：皮肤分析id 必须
     */
    ...
    /**
     * api： en.orderConfirmation.getList
     * 功能：获取皮肤分析列表
    ...
    /**
     * api： en.orderConfirmation.delete
     * 功能：删除皮肤分析信息
     * 调用：CT_Api::post();
     * 参数：$id: 皮肤分析id  必须
     */
    ...
    /**
     * api： en.orderConfirmation.clearCacheById
     * function：clear cache data by id
     * call：CT_Api::post();
     * param：$id: orderConfirmation id  (must be assigned)
     */
