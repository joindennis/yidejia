 ...
 * 栏目：国际站API
 */
class api_en_mmfStylists {

    private $model;

    public function __construct() {
        $this->model = new module_en_mmfStylists();
    }

    /**
     * api： en.mmfStylists.get
     * 功能：根据皮肤分析ID获取皮肤分析信息
     * 调用：CT_Api::get();
     * 参数：$id：皮肤分析id 必须
     */
