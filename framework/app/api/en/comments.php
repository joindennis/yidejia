 ...
 * 栏目：国际站API
 */
class api_en_comments {

    private $model;

    public function __construct() {
        $this->model = new module_en_comments();
    }
    ...
    public function delete() {
        ...
        $id = core::getInput("id");
        $result = $this->model->thumbsDown($id);
        if ($result) {
            //存在
            core::outPut(1, $result);
        } else {
