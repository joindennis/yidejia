...
/**
 * 模块：en.commentsThumbs
 * 功能: 国际站评论管理
 * 栏目：国际站API
 */
class api_en_commentsThumbs {

    private $model;

    public function __construct() {
        $this->model = new module_en_commentsThumbs();
    }

    /**
     * api： en.commentsThumbs.get
     * 功能：根据评论id获取评论信息
     * 调用：CT_Api::get();
     * 参数：$id：评论id
     */
