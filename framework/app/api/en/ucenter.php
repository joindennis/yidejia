 ...
 * 栏目：国际站API
 */
class api_en_ucenter {

    private $model;

    public function __construct() {
        $this->model = new module_en_ucenter();
    }
    ...
    /**
     * api： en.ucenter.clearCacheById
     * function：clear cache data by id
     * call：CT_Api::post();
     * param：$id: ucenter id  (must be assigned)
     */
